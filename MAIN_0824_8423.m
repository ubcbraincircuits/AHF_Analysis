...
varOpen.file(2).rep = 'D:\20180824'; 
varOpen.file(3).rep = 'D:\20180824';
...
varOpen.filecam =  'E:\cage_5_oct_2018_tet\eye\'; % where behavioural videos are stored (raw data) 
...
varOpen.varProc.run_list=[1:22 24:37, 40:120, 122:136]; % Indicate the expe files you want displayed. 
%expe([59])=[]
...
varOpen.Seed.redo_roi=1; % roi need to be redrawn? 0= no, 1= yes
