...
varOpen.working_folder = 'D:\20180824-474\Processed\'; % state working folder in which all info gets saved into

varOpen.file(1).rep = 'D:\07302018_Tet_\20180824\3\Videos\'; % load the .raw files 
varOpen.file(2).rep = 'D:\07302018_Tet_\20180825\3\Videos\'; 
varOpen.file(3).rep = 'D:\07302018_Tet_\20180826\3\Videos\';
varOpen.file(4).rep = 'D:\07302018_Tet_\20180827\3\Videos\';
varOpen.file(5).rep = 'D:\07302018_Tet_\20180828\3\Videos\';
varOpen.file(6).rep = 'D:\07302018_Tet_\20180829\3\Videos\';
...
varOpen.filesave = 'D:\20180824-474\Processed\20180824_29'; % save as this name in the .mat file followed by mouse # and n mat files
varOpen.filecam =  'D:\07302018_Tet_\video_eye\'; % where behavioural videos are stored (.h264) and get converted into .mp4 
...
varOpen.delete = 0 % delete the behavioural and averaging files 1= delete 0= no 
...
varOpen.varProc.run_list=[3:11, 13, 15:30, 34:41]; % Indicate the expe files you want displayed. 
%expe([59])=[]
%varOpen.varProc.run_list=[57];
varOpen.varProc.tb = 3; % temporal binning- 1 indicates no change (downsizing factor) 
varOpen.varProc.useBe1=1; % different behavioural cams to monitor different parts of the body 
varOpen.varProc.useBe2=1; % 1 = turn on; 0= turn off 
varOpen.varProc.useBe3=1;
varOpen.varProc.Ca_flipLR=1; % flip image of calcium data
...
varOpen.ave.mvt_kSD = 0.4; % will discard trial if mvt above threshold (mvt_kSD x std dev)
...
qtype_list= [2]; % specify qtype corresponding to GO trial stated above 
...
for m= 1:length(qtype_list)
    ...
    varOpen.ave.outfile=[varOpen.ave.qtype_folder qtype_files{m}]; % data is saved in both Ave_temp.mat and qtype2.mat file 
...
varOpen.singletrial.roi= 1 % determine which ROI you want to view 
...
varOpen.singletrial.time = [1:50] % frame interval being observed [min:max]
